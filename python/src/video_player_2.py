...
class PlaybackInterface:
    ...
    def __init__(self):
        ...
        self.uri = "http://docs.gstreamer.com/media/sintel_trailer-480p.webm"
        ...
        filesink.location = "/home/smonni/test_video.yuv"
        self.player.set_property("video-sink", filesink)
