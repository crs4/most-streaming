...
static void check_initialization_complete (CustomData *data) {
  ...
  if (!data->initialized && data->native_window && data->main_loop) {
    ...
    //gst_x_overlay_set_window_handle (GST_X_OVERLAY (data->video_sink), (guintptr)data->native_window); // OLD!!!
...
static void *app_function (void *userdata) {
  ...
  data->pipeline = gst_parse_launch("playbin uri=rtsp://user:pwd@192.168.1.100/mpeg4/media.amp latency=0", &error);
