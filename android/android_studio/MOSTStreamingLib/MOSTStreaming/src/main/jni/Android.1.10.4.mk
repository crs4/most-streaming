...
LOCAL_SHARED_LIBRARIES := gstreamer_android
LOCAL_LDLIBS := -llog -landroid
LOCAL_STATIC_LIBRARIES := rtsp-server
include $(BUILD_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := gstnet-lib
LOCAL_SRC_FILES :=$(GSTREAMER_ROOT)/lib/libgstnet-1.0.a
...
# GSTREAMER_PLUGINS         := coreelements ogg theora vorbis videoconvert audioconvert audioresample playback soup opensles
